...
class Point < GeometryValue
  ...
  private
  def inbetween v, r1, r2
    (r1 - GeometryExpression::Epsilon <= v and
     v <= r2 + GeometryExpression::Epsilon) or
    (r2 - GeometryExpression::Epsilon <= v and
     v <= r1 + GeometryExpression::Epsilon)
  end
end
