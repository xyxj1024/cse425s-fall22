...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (call mupl-double (int 425))) (int 850) "mupl-double test")
   ...
   (check-equal? (eval-exp (call (call mupl-sum-curry (int 20)) (int 22))) (int 42) "mupl-sum-curry test")
   ...
   (check-equal? (eval-exp (call mupl-map-one (fun #f "x" (call mupl-double (var "x"))))) (int 2) "mupl-map-one test")
   ))
